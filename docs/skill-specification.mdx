...
description: "Compatibility reference for the underlying SKILL.md format."
---

This document defines the `SKILL.md` format that Agent Epics builds on. It is
kept here as a compatibility reference.
...
- Values are usually strings, but shared conventions such as `metadata.source`
  may use a structured value
